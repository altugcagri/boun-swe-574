...
export class PathElement extends Component {
    handleDeleteContentById(contentId) {
        ...
        axios
            ...
            .then(res => {
                toast.notify("Material deleted successfully.", {
                    position: "top-right"
                });
                    ...
                    {editable && (
                        <React.Fragment>
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    this.handleDeleteContentById(content.id)
                                }
                            >
                                <FontAwesomeIcon icon={faTrash} />
                            </Button>
                            <Link
                                className="btn  btn-outline-primary btn-sm ml-2 inlineBtn"
...
export class Question extends Component {
    ...
    handleDeleteQuestionById(questionIdToDelete) {
        let url = resolveEndpoint("deleteQuestionById", [
            { slug1: questionIdToDelete }
        ]);

        axios
            .delete(url, REQUEST_HEADERS)
            .then(res => {
                toast.notify("Question deleted successfully.", {
                    position: "top-right"
                });
                this.props.handleRefresh();
            })
                    ...
                    {editable && (
                        <React.Fragment>
                            ...
                            <Button
                                ...
                                variant="outline-danger"
                                onClick={() =>
                                    this.handleDeleteQuestionById(question.id)
                                }
                            >
                                <FontAwesomeIcon icon={faTrash} />
                            </Button>
